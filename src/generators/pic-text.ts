...
export function picTextGenerator(): void {
  ...
  const getTextInputElement = <HTMLInputElement>document.getElementById(`${attribute}-text`);
 ...
 * @return {void} nothing
 */
function getPicTextResult(attribute: string, outputNode: HTMLElement, text: string): void {
  let imageText: string = `################################################################################################################################################################################################################################################################################################################################################################################################################################################################################################################################################################################################`;

  const getImageButtonElement = <HTMLInputElement>document.querySelector(`[data-button = ${attribute}]`);
...
export function getImageFile(attribute: string): void {
  const getImageEntryElement = <HTMLInputElement>document.getElementById(`${attribute}-file`);
