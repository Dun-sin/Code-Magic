...
export function gradientTextGenerator(): void {
  ...
  function onClickButton() {
    ...
    getGradientTextResult(attribute, getInputElement.value, values, getOutputElement);
 ...
 * @return {void} nothing
 */
function getGradientTextResult(attribute: string, text: string, values: Values, outputElement: HTMLElement): void {
